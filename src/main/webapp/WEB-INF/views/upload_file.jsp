			...
			<div class="panel with-nav-tabs panel-primary">
				<div class="panel-heading">
					<ul class="nav nav-tabs">
						<li class="active"><a href="" data-toggle="tab" class="btn-9"><i
								class="fa fa-file-text" aria-hidden="true"></i>Carga de Archivos</a></li>
					</ul>
				</div>
					...
					<div class="col-md-12">
						<form action="file_upload" method="post"
							...
							<div class="form-group files color">
								<label>Suba su archivo csv </label> <input type="file"
							...
							<div class="col-md-12">
								<button type="submit" value="Upload File"
									...
									<span class="btn-label"><i
										class="glyphicon glyphicon-ok"></i></span>Guardar
								</button>
							</div>
						</form>
					</div>
